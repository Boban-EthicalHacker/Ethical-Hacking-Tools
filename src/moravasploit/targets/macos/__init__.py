# Модул за macOS систем.
# Садржи мени категорија за macOS.
...
# Речник категорија модула за macOS.
CATEGORIES = {
    "1": "recon",
    "2": "exploits",
    "3": "post",
...
def menu() -> str | None:
    """Приказује мени категорија за macOS и враћа избор."""
    # Исписујемо наслов менија.
    console.print("\n[bold]macOS - choose category:[/bold]\n")
